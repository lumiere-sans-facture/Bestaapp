...
const normalizePhoneNumber = (phone: unknown, country = PAYS_PAR_DEFAUT) => {
  ...
  const isBenin = country.toUpperCase() === 'BJ';
  // Un indicatif international explicitement saisi (ex. +228) ne doit jamais
  // être préfixé par +229, même lorsque l'organisation est au Bénin.
