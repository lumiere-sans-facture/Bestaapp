        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: 'clamp(48px, 6vw, 88px) clamp(20px, 5vw, 48px)' }}>
          ...
          <div id="schemas" style={{ marginTop: 'clamp(32px, 4vw, 56px)', background: '#f2f5fa', border: '1px solid #e3e7ef', borderRadius: '16px', padding: 'clamp(20px, 3vw, 32px)' }}>
            ...
            <div style={stylePanneau(0)}>
              <div style={{ background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: 'clamp(18px, 2.5vw, 28px)', overflowX: 'auto' }}>
                <div className="lp-schema" style={{ minWidth: '680px', display: 'grid', gridTemplateColumns: '1fr 0.75fr 1fr 0.75fr 1fr', alignItems: 'center', gap: '0 10px' }}>
                  <div className="lp-schema-bloc" style={{ gridColumn: '3', gridRow: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '14px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                  ...
                  <div className="lp-schema-lienv" style={{ gridColumn: '3', gridRow: '2', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '6px 0' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '1', gridRow: '3', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '16px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '3', gridRow: '3', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#001744', border: '1px solid #001744', borderRadius: '12px', padding: '18px 12px', boxShadow: '0 12px 32px rgba(0,23,68,.10)', textAlign: 'center' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '5', gridRow: '3', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '16px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                  ...
                  <div className="lp-schema-lienv" style={{ gridColumn: '3', gridRow: '4', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '6px 0' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '3', gridRow: '5', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '14px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
            ...
            <div style={stylePanneau(1)}>
              <div style={{ background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: 'clamp(18px, 2.5vw, 28px)', overflowX: 'auto' }}>
                <div className="lp-schema" style={{ minWidth: '680px', display: 'grid', gridTemplateColumns: '1fr 0.75fr 1fr 0.75fr 1fr', alignItems: 'center', gap: '0 10px' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '5', gridRow: '3', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #ffd37f', borderRadius: '12px', padding: '16px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
            ...
            <div style={stylePanneau(2)}>
              <div style={{ background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: 'clamp(18px, 2.5vw, 28px)', overflowX: 'auto' }}>
                <div className="lp-schema" style={{ minWidth: '700px', display: 'grid', gridTemplateColumns: '1fr 0.8fr 1fr 0.8fr 1fr', alignItems: 'center', gap: '0 10px' }}>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '1', gridRow: '2', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '16px 10px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                    <span style={{ width: '40px', height: '40px', flexShrink: '0', borderRadius: '10px', background: '#fff6e5', color: '#b87400', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="7" x="3" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="14" rx="1"></rect><rect width="7" height="7" x="3" y="14" rx="1"></rect></svg></span>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '3', gridRow: '2', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#001744', border: '1px solid #001744', borderRadius: '12px', padding: '18px 10px', boxShadow: '0 12px 32px rgba(0,23,68,.10)', textAlign: 'center' }}>
                    <span style={{ width: '40px', height: '40px', flexShrink: '0', borderRadius: '10px', background: '#ffa800', color: '#001744', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg></span>
                    <span style={{ fontSize: '0.875rem', fontWeight: '600', color: '#ffffff', lineHeight: '1.25' }}>Onduleur hybride (MPPT intégré)</span>
                  ...
                  <div className="lp-schema-bloc" style={{ gridColumn: '5', gridRow: '2', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: '16px 10px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                    <span style={{ width: '40px', height: '40px', flexShrink: '0', borderRadius: '10px', background: '#edf1fa', color: '#0c3483', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"></path><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path></svg></span>
            ...
            <div style={stylePanneau(3)}>
              <div style={{ background: '#ffffff', border: '1px solid #e3e7ef', borderRadius: '12px', padding: 'clamp(18px, 2.5vw, 28px)', overflowX: 'auto' }}>
                <div className="lp-schema" style={{ minWidth: '680px', display: 'grid', gridTemplateColumns: '1fr 0.75fr 1fr 0.75fr 1fr', alignItems: 'center', gap: '0 10px' }}>
                  <div className="lp-schema-bloc" style={{ gridColumn: '5', gridRow: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', background: '#ffffff', border: '1px solid #ffd37f', borderRadius: '12px', padding: '14px 12px', boxShadow: '0 1px 2px rgba(0,23,68,.05),0 6px 18px rgba(0,23,68,.05)', textAlign: 'center' }}>
                  ...
                  <div className="lp-schema-lienv" style={{ gridColumn: '5', gridRow: '2', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '6px 0' }}>
