// Actions métier (mutations d'état). Chaque action utilise la forme
// setState((s) => …) et ne dépend d'aucun état React : elle se factorise donc
// proprement hors du Provider. createActions(setState) renvoie l'API d'actions.
import { generatePartnerCode, getActiveRef } from '../utils/referral';
