...
def main():
    ...
    # Output dir: SOLAR_DATA_DIR env override (absolute or relative to CWD),
    # else the repo-level `data/` dir alongside the skills.
    output_dir = os.environ.get("SOLAR_DATA_DIR", "").strip()
    if output_dir:
